...
void kasus1P11() {
  ...
  auto soal1 = [&]() {
    do {
      ...
      cout << "Nilai max dari A, B, C, D adalah\t: " << max4(a, b, c, d)
           << endl;
  ...
  auto soal2 = [&]() {
    ...
    do {
      ...
      cin >> pangkat;
      cout << "-------------------------------" << endl;
      cout << "Hasil dari Nilai pangkat adalah\t\t: "
           << (data = hasilPangkat(a, pangkat)) << endl;
      cout << "Hasil dari Nilai pangkat berupa angka\t: "
           << (isGanjil(data) == false ? "Bilangan Genap" : "Bilangan Ganjil")
           << endl;
      cout << "\nApakah kamu ingin mengulanginya lagi : ";
      cin >> restart;
      cin.ignore(numeric_limits<streamsize>::max(), '\n');
...
void kasus2P11() {
  ...
  auto soal1 = [&]() {
    ...
    cin >> n;
    cout << "Luas Persegi ( s = " << n << " ) adalah : " << luasPersegi(n)
         << endl;
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
  };
  ...
  auto soal4 = [&]() {
    ...
    cout << "Masukkan bilangan yang diinginkan : ";
    cin >> n;
